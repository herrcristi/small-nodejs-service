...
const Service2ServiceAuthMiddleware = require('./users-auth/service2service-auth.middleware.js');
...
const Public = {
  ...
  getUsersAuthMiddlewares: () => {
    return [Service2ServiceAuthMiddleware, UsersAuthMiddleware]; // in this order
  },
};
