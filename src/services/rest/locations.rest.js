...
const Public = {
  ...
  getAll: async (queryParams, _ctx) => {
    return await RestCommsUtils.getAll(LocationsConstants.ServiceName, queryParams, _ctx);
  },

  getAllByIDs: async (ids, projection, _ctx) => {
    return await RestCommsUtils.getAllByIDs(LocationsConstants.ServiceName, ids, projection, _ctx);
  },
  ...
  getOne: async (objID, projection, _ctx) => {
    return await RestCommsUtils.getOne(LocationsConstants.ServiceName, objID, projection, _ctx);
  },
  ...
  post: async (objInfo, _ctx) => {
    return await RestCommsUtils.post(LocationsConstants.ServiceName, objInfo, _ctx);
  },
  ...
  delete: async (objID, _ctx) => {
    return await RestCommsUtils.delete(LocationsConstants.ServiceName, objID, _ctx);
  },
  ...
  put: async (objID, objInfo, _ctx) => {
    return await RestCommsUtils.put(LocationsConstants.ServiceName, objID, objInfo, _ctx);
  },
  ...
  patch: async (objID, patchInfo, _ctx) => {
    return await RestCommsUtils.patch(LocationsConstants.ServiceName, objID, patchInfo, _ctx);
  },
  ...
  notification: async (notification, _ctx) => {
    return await RestCommsUtils.notification(LocationsConstants.ServiceNameInternal, notification, _ctx);
  },
  ...
  raiseNotification: async (notificationType, objs, _ctx) => {
    const config = { serviceName: LocationsConstants.ServiceName, subscribers: Private.Subscribers };
    return await NotificationsUtils.raiseNotification(config, notificationType, objs, _ctx);
  },
};

module.exports = { ...Public, Constants: LocationsConstants };
