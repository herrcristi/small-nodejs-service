...
describe('Admins Rest', function () {
  ...
  it('should call getAll via rest', async () => {
    ...
    // call
    let res = await AdminsRest.getAll('?', _ctx);
  ...
  it('should call getAllByIDs via rest', async () => {
    ...
    // call
    let res = await AdminsRest.getAllByIDs(['id1'], { id: 1, name: 1 } /*projection*/, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should call getOne via rest', async () => {
    ...
    // call
    let res = await AdminsRest.getOne('id1', {}, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should post a call via rest', async () => {
    ...
    // call
    let res = await AdminsRest.post({}, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should delete a call via rest', async () => {
    ...
    // call
    let res = await AdminsRest.delete('id1', _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should put a call via rest', async () => {
    ...
    // call
    let res = await AdminsRest.put('id1', {}, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should patch a call via rest', async () => {
    ...
    // call
    let res = await AdminsRest.patch('id1', {}, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should do notification a call via rest', async () => {
    ...
    // call
    let res = await AdminsRest.notification({}, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should do subscribe', async () => {
    // call
    let res = await AdminsRest.subscribe({ callback: null, projection: { id: 1 } }, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should do consume', async () => {
    ...
    // call
    let res = await AdminsRest.consume({ callback: null, projection: { id: 1 } }, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should do raiseNotification', async () => {
    ...
    // call
    let res = await AdminsRest.raiseNotification(
