...
describe('Admins Service', function () {
  ...
  it('should postForUsers with success', async () => {
    ...
    // call
    let res = await AdminsService.postForUsers([postReq], _ctx);
  ...
  it('should postForUsers no users', async () => {
    ...
    // call
    let res = await AdminsService.postForUsers([], _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should postForUsers failed tenant', async () => {
    // call
    let res = await AdminsService.postForUsers([], { ..._ctx, tenantID: undefined });
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
