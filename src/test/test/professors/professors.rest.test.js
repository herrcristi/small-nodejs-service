...
describe('Professors Rest', function () {
  ...
  it('should call getAll via rest', async () => {
    ...
    // call
    let res = await ProfessorsRest.getAll('?', _ctx);
  ...
  it('should call getAllByIDs via rest', async () => {
    ...
    // call
    let res = await ProfessorsRest.getAllByIDs(['id1'], { id: 1, name: 1 } /*projection*/, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should call getOne via rest', async () => {
    ...
    // call
    let res = await ProfessorsRest.getOne('id1', _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should post a call via rest', async () => {
    ...
    // call
    let res = await ProfessorsRest.post({}, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should delete a call via rest', async () => {
    ...
    // call
    let res = await ProfessorsRest.delete('id1', _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should put a call via rest', async () => {
    ...
    // call
    let res = await ProfessorsRest.put('id1', {}, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should patch a call via rest', async () => {
    ...
    // call
    let res = await ProfessorsRest.patch('id1', {}, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should do notification a call via rest', async () => {
    ...
    // call
    let res = await ProfessorsRest.notification({}, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should do subscribe', async () => {
    // call
    let res = await ProfessorsRest.subscribe({ callback: null, projection: { id: 1 } }, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should do consume', async () => {
    ...
    // call
    let res = await ProfessorsRest.consume({ callback: null, projection: { id: 1 } }, _ctx);
    console.log(`\nTest returned: ${JSON.stringify(res, null, 2)}\n`);
  ...
  it('should do raiseNotification', async () => {
    ...
    // call
    let res = await ProfessorsRest.raiseNotification(
