...
describe('Base Controller', function () {
  ...
  it('should put with success', async () => {
    ...
    // call
    await BaseControllerUtils.put(service, serviceName, req, res, next);

    // check
    chai.expect(status).to.equal(200);
    chai.expect(service.put.callCount).to.equal(1);
