...
describe('Base Service', function () {
   ...
   */
  it('should call broadcast with success', async () => {
    const objs = [
      {
        id: 'id4',
        name: 'name4',
    ...
    // call
    let res = await NotificationsUtils.broadcast(config, NotificationsUtils.Constants.Notification.Added, objs, _ctx);
