...
describe('Rest Communications Utils', function () {
  ...
  /**
   * login local with success
   */
  it('should call login local with success', async () => {
    // local config
   ...
   * login local fail
   */
  it('should call login local and fail', async () => {
    // local config
    let serviceName = 'Service';
    let localConfig = {
      local: {
  ...
  /**
   * login remote with success
   */
  it('should call login remote with success', async () => {
    // local config
    let serviceName = 'Service';
    let restConfig = {
      rest: {
        [serviceName]: {
          ...
          path: '/api/internal_v1/service/login',
        },
      },
    };
  ...
  /**
   * login remote with failure
   */
  it('should call login remote with failure', async () => {
    // local config
    let serviceName = 'Service';
    let restConfig = {
      rest: {
