...
const apiFields = {
  ...
  filterFields: ['name', '_lang_en.status', 'address'],
  addFields: ['name', 'status', 'address'],
  editFields: ['name', 'status', 'address'],
};
...
async function handleSubmit() {
  ...
  // trim
  ComponentsUtils.Edit.trimFields(itemData, ['name', 'address']);
